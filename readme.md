...
* protocol
  ...
  * `/purchase` skip the line like (540 beans, Woo). even though frontend sends expected price, it appears backend deducts 540 anyway. multiple Woos appear to have no effects on the same profile.
